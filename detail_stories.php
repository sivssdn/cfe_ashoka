 ...
 <body>
	...
	<div id="head">
		...
		<div id="menu">
			...
			<span id="d"><a href="#mentors" id="m1" onclick="change(5);">PROGRAMMES</a></span> &nbsp;&nbsp;&nbsp;
	...
	<div id="detail_content">
		...
		<?php
			...
			case 8:
					...
					break;
			case 9:
					echo "<br><br><span id='short_h' style='color:rgba(255,51,51,1);'>Dalmia bharat AIM smart city Accelerator by Holostik India</span>";
					echo "<p>
						India is looking for smart solutions for its urban chaos &#45 an infrastructure solution where street and home lighting is universal, costs less than it does now and uses less energy. With seven billion people on the planet, we&#39re running out of space and time for traditional solutions to work. Connected solutions and systems are the only way forward. It&#39s why cities need to smarten up. It&#39s why technology in this space urgently needs fast&#45tracking &#45 to productize ideas and bring these solutions to the market for rapid and mass adoption.
					</p>
					<p>
						It&#39s also why Ashoka University&#44 DLabs at the Indian School of Business&#44 and Microsoft joined hands to create the AIM Smart City accelerator programme that will not only provide startups with funding and technological assistance, but also crucial skills&#44 as well as direct access to investors and most importantly&#44 to customers.
					</p>
					<p>
						Together, the group has accelerated a number of startups across industries, providing them with in house mentors and sponsors to help develop technical and managerial skills. Individually, too, their track records speak volumes: Microsoft Ventures was rated as the #1 accelerator/ incubator programme in the region in 2015 and will provide access to all its technical expertise and networks to the chosen startups. Ashoka University is India&#39s leading liberal arts varsity focused on providing a well&#45rounded education that nurtures the leaders of tomorrow, while ISB is Asia&#39s leading B School. The faculty at both universities comprise well&#45known experts with deep links in industry, venture capital, and government.
					</p>
					";
					break;
			case 10:
					echo "<br><br><span id='short_h' style='color:rgba(255,51,51,1);'>Entrepreneur in Residence</span>";
					echo "<p>		
							This is an exciting program that allows Fellows to stay back on Campus for a period of 6 months after graduation, to work on their entrepreneurial idea and take it to a fundable business plan stage. Through this process the entrepreneur is support by the Centre and has a faculty & a founder assigned as mentors. As part of the being an Entrepreneur in Residence at Ashoka, you stay on campus free of cost and also get paid to work on your own venture.
							</p>
